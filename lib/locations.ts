...
export const LOCATIONS: Location[] = [
  {
    ...
    spots: [
      ...
      { name: "Porto Batel", facing: 245, swellDirMin: 220, swellDirMax: 330, swellMin: 1.0, swellMax: 3.0, offshoreWindMin: 20, offshoreWindMax: 80, periodMin: 9, tide: "mid to high", notes: "Reef/point south of Consolacao. NE offshore, sheltered from N wind. Rights. Needs bigger swell." },
      ...
      { name: "Cantinho da Baia", facing: 350, swellDirMin: 300, swellDirMax: 355, swellMin: 0.8, swellMax: 2.0, offshoreWindMin: 90, offshoreWindMax: 180, periodMin: 8, tide: "all tides", notes: "Corner of bay. Long rights in big N or medium NW swell. NE-SE wind clean." },
